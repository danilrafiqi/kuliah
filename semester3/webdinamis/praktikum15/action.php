...
$delete = "delete from tbl_daftar_mahasiswa where iddaftar = '$id'";
$delete_query = mysqli_query($koneksi, $delete);
if ($delete_query) echo "Record $id berhasil dihapus!<br><META HTTP-EQUIV=Refresh CONTENT='2;
URL=lihatdata.php'>";
...
{
$select = "select * from tbl_daftar_mahasiswa where iddaftar = '$id'";
$select_query = mysqli_query($koneksi,$select);
while($select_result = mysqli_fetch_assoc($select_query))
{
...
<tr><td>Nama</td><td><input type="text" name="nama" value="<?php echo $nama ; ?>" size="30"
maxlength="50"/></td></tr>
<tr><td>Jenis Kelamin</td><td><input type="radio" name="jenis_kelamin" value="pria"/><label
for="jenis_kelamin">Pria</label>
<input type="radio" name="jns_kelamin" value="wanita"/><label for="jenis_kelamin">Wanita</label>
</td></tr>
...
<tr><td>Lulusan Sekolah</td><td><input type="text" name="sekolah" value="<?php echo $lulusan ; ?>"
...
<tr><td>Pekerjaan</td><td><input type="text" name="pekerjaan" value="<?php echo $pekerjaan ; ?>"
size="30" maxlength="50"/></td></tr>
<tr><td>Alamat</td><td><textarea name="alamat" cols="30" rows="4"><?php echo $alamat ;
?></textarea></td></tr>
<tr><td>Kelurahan</td><td><input type="text" name="kelurahan" value="<?php echo $kelurahan ; ?>"
size="30" maxlength="50"/></td></tr>
<tr><td>Kecamatan</td><td><input type="text" name="kecamatan" value="<?php echo $kecamatan; ?>"
size="30" maxlength="50"/></td></tr>
<tr><td>Kota</td><td><input type="text" name="kota" size="30" value="<?php echo $kota ; ?>"
maxlength="50"/></td></tr>
...
<tr><td>No Telepon</td><td><input type="text" name="telepon" size="30" value="<?php echo $telepon ;
?>" maxlength="50"/></td></tr>
